...
public class TEISRMachineGun extends TileEntityItemStackRenderer {
	private static final ResourceLocation MODEL = new ResourceLocation("zone:models/item/machine_gun.obj");
