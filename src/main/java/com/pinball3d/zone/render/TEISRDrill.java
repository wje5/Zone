...
public class TEISRDrill extends TileEntityItemStackRenderer {
	private static final ResourceLocation MODEL = new ResourceLocation("zone:models/item/drill.obj");
