...
@ZenRegister
@ZenClass("mods.zone.charger")
public class TweakerCharger {
	@ZenMethod
	public static void addRecipe(IItemStack input, IItemStack output, int time) {
		...
		RecipeHandler.register(new RecipeCharger(i, o, time));
	}
	...
	public static void removeRecipe(IItemStack input) {
		...
		Recipe r = RecipeHandler.getRecipe(Type.CHARGER, Arrays.asList(i));
		if (r != null) {
	...
	public static void removeAll() {
		RecipeHandler.removeAll(Type.CHARGER);
	}
}
