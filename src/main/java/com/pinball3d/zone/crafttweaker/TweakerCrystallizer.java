...
@ZenRegister
@ZenClass("mods.zone.crystallizer")
public class TweakerCrystallizer {
	@ZenMethod
	public static void addRecipe(IItemStack input, IItemStack output, int time) {
		...
		RecipeHandler.register(new RecipeCrystallizer(i, o, time));
	}
	...
	public static void removeRecipe(IItemStack input) {
		...
		Recipe r = RecipeHandler.getRecipe(Type.CRYSTALLIZER, Arrays.asList(i));
		if (r != null) {
	...
	public static void removeAll() {
		RecipeHandler.removeAll(Type.CRYSTALLIZER);
	}
}
