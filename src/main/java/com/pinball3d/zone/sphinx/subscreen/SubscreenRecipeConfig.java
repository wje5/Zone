...
public class SubscreenRecipeConfig extends Subscreen {
	public ScrollingList list;

	public SubscreenRecipeConfig(IHasSubscreen parent) {
	...
	public void doRenderBackground(int mouseX, int mouseY) {
		...
		Util.renderGlowString(I18n.format("sphinx.recipe_config"), 15, 8);
