...
public class SubscreenSphinxInitWizard extends Subscreen {
	...
	public SubscreenSphinxInitWizard(IHasSubscreen parent) {
		this(parent, getDisplayWidth() / 2 - 150, getDisplayHeight() / 2 - 100);
	}

	public SubscreenSphinxInitWizard(IHasSubscreen parent, int x, int y) {
		...
		components.add(new TextButton(this, this.x + 242 - w, this.y + 175, s, () -> {
			parent.removeScreen(SubscreenSphinxInitWizard.this);
