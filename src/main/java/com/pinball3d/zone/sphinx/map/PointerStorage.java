...
public class PointerStorage extends PointerNeedNetwork {
	public PointerStorage(WorldPos pos, SerialNumber serial, int id, WorkingState state) {
	...
	public void render(int offsetX, int offsetZ) {
		Util.drawTexture(SPHINX_ICONS, pos.getPos().getX() - offsetX - 3, pos.getPos().getZ() - offsetZ - 3, 149, 0, 13, 13,
				0.5F);
	}
}
