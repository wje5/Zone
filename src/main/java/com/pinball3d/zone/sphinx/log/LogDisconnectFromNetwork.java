...
public class LogDisconnectFromNetwork extends Log {
	private UUID uuid;
	private String name;
	...
	public LogDisconnectFromNetwork(int id, EntityPlayer player, SerialNumber serial, WorldPos pos) {
		super(Level.INFO, Type.DISCONNECTFROMNETWORK, id);
	...
	public LogDisconnectFromNetwork(NBTTagCompound tag) {
		super(tag);
	}
	...
	public FormattedLog format() {
		return new FormattedLog(getTime(), getLevel(), "log.disconnect_from_network",
