...
public class LogDenyPermission extends Log {
	private UUID uuid, uuid2;
	private String name, name2;
	private boolean playerDead, playerDead2;

	public LogDenyPermission(int id, EntityPlayer player, UUID uuid2, String name2) {
		super(Level.IMPORTANT, Type.DENYPERMISSION, id);
	...
	public LogDenyPermission(NBTTagCompound tag) {
		super(tag);
	}
	...
	public FormattedLog format() {
		return new FormattedLog(getTime(), getLevel(), "log.deny_permission",
