...
public class LogTransferAdmin extends Log {
	private UUID uuid, uuid2;
	private String name, name2;
	private boolean playerDead, playerDead2;

	public LogTransferAdmin(int id, EntityPlayer player, UUID uuid2, String name2) {
		super(Level.IMPORTANT, Type.TRANSFERADMIN, id);
	...
	public LogTransferAdmin(NBTTagCompound tag) {
		super(tag);
	}
	...
	public FormattedLog format() {
		return new FormattedLog(getTime(), getLevel(), "log.transfer_admin",
