...
public class ContainerManualSphinxSystem3 extends ContainerManual {
	public ContainerManualSphinxSystem3(EntityPlayer player) {
		super(player);
		addSlotToContainer(new SlotItemFrame(65, 22, new ItemStack(ItemLoader.construct_block_axis_y)));
		addSlotToContainer(new SlotItemFrame(65, 38, new ItemStack(BlockLoader.truss)));
		addSlotToContainer(new SlotItemFrame(65, 54, new ItemStack(BlockLoader.processing_center)));
		addSlotToContainer(new SlotItemFrame(65, 70, new ItemStack(BlockLoader.truss)));
		addSlotToContainer(new SlotItemFrame(65, 86, new ItemStack(ItemLoader.construct_block_axis_y)));
		addSlotToContainer(new SlotItemFrame(49, 30, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(49, 78, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(81, 30, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(81, 78, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(33, 38, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(33, 54, new ItemStack(BlockLoader.truss)));
		addSlotToContainer(new SlotItemFrame(33, 70, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(97, 38, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(97, 54, new ItemStack(BlockLoader.truss)));
		addSlotToContainer(new SlotItemFrame(97, 70, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(17, 46, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(17, 62, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(113, 46, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(113, 62, new ItemStack(BlockLoader.charged_glass)));
		addSlotToContainer(new SlotItemFrame(1, 54, new ItemStack(ItemLoader.construct_block_axis_y)));
		addSlotToContainer(new SlotItemFrame(129, 54, new ItemStack(ItemLoader.construct_block_axis_y)));
