...
public class GuiContainerManualSphinxSystem2 extends GuiContainerManualBase {
	public GuiContainerManualSphinxSystem2(ContainerManual container) {
		super(container);
	}
	...
	public void addComponents() {
		...
		components
				.add(new BlockShowWithTip(this, x + 65, y + 38, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components
				.add(new BlockShowWithTip(this, x + 65, y + 54, 1.0F, new ItemStack(BlockLoader.dynavolt_restrainer)));
		components
				.add(new BlockShowWithTip(this, x + 65, y + 70, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components
		...
		components
				.add(new BlockShowWithTip(this, x + 49, y + 46, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components
				.add(new BlockShowWithTip(this, x + 49, y + 62, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components.add(
		...
		components
				.add(new BlockShowWithTip(this, x + 81, y + 46, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components
				.add(new BlockShowWithTip(this, x + 81, y + 62, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components.add(
		...
		components
				.add(new BlockShowWithTip(this, x + 33, y + 54, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components.add(
		...
		components
				.add(new BlockShowWithTip(this, x + 97, y + 54, 1.0F, new ItemStack(BlockLoader.construct_block_all)));
		components.add(
