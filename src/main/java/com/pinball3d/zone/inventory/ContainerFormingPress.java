...
public class ContainerFormingPress extends ContainerTieredMachine {
	private IItemHandler battery, input, output;
	private int tick, totalTick;

	public ContainerFormingPress(EntityPlayer player, TEFormingPress tileEntity) {
	...
	public void detectAndSendChanges() {
		...
		if (!tileEntity.getWorld().isRemote) {
			tick = ((TEFormingPress) tileEntity).getTick();
			totalTick = ((TEFormingPress) tileEntity).getTotalTick();
		}
