...
public class GuiContainerExtruder extends GuiContainer {
	public static final ResourceLocation TEXTURE = new ResourceLocation("zone:textures/gui/container/grinder.png");

	protected ContainerExtruder container;

	public GuiContainerExtruder(ContainerExtruder container) {
		super(container);
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		String title = I18n.format("tile.extruder_" + container.getTier() + ".name");
