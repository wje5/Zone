...
public class GuiContainerFormingPress extends GuiContainer {
	public static final ResourceLocation TEXTURE = new ResourceLocation(
			"zone:textures/gui/container/forming_press.png");

	protected ContainerFormingPress container;

	public GuiContainerFormingPress(ContainerFormingPress container) {
		super(container);
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		String title = I18n.format("tile.forming_press_" + container.getTier() + ".name");
