...
public class TECentrifuge extends ZoneTieredMachine {
	protected int tick, totalTick;
	protected ItemStackHandler input = new ItemStackHandler();
	protected ItemStackHandler output = new ItemStackHandler(3);
	protected ItemStackHandler expectOutput = new ItemStackHandler(3);
